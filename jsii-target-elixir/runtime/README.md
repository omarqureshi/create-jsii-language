...
original JavaScript implementation. The guest runtime is the Elixir library
...
| `errors` | kernel faults -> idiomatic Elixir exceptions, preserving JS error kind | `lib/jsii/errors.rb` |
