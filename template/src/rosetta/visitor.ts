 ...
 */
interface {{Lang}}LanguageContext {
  readonly [key: string]: unknown;
}

/**
 * Translates TypeScript example snippets to {{Lang}} for documentation.
 *
 ...
 */
export class {{Lang}}Visitor extends DefaultVisitor<{{Lang}}LanguageContext> {
  /**
  ...
  public readonly language = '{{lang}}' as TargetLanguage;

  public readonly defaultContext: {{Lang}}LanguageContext = {};

  public readonly indentChar: ' ' | '\t' = ' ';

  public mergeContext(old: {{Lang}}LanguageContext, update: Partial<{{Lang}}LanguageContext>): {{Lang}}LanguageContext {
    return { ...old, ...update };
  }
}
