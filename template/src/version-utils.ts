 ...
 * version format.
 */
export function to{{Lang}}ReleaseVersion(assemblyVersion: string): string {
  // TODO({{lang}}): map prerelease labels (alpha/beta/rc/dev/...) to your
 ...
 */
export function to{{Lang}}VersionRange(semverRange: string): string {
  // TODO({{lang}}): map ^ / ~ / comparators / OR-sets. Reject unsupported
