 ...
 * renders with derived PascalCase (derived instead of decided), which becomes permanent
...
const overlayFile = process.env.JSII_{{LANG}}_TARGET_CONFIG ?? path.join(__dirname, '..', 'config', 'cdk-targets.json');
