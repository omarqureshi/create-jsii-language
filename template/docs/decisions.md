...
How do assembly/module/type names map into {{Lang}}?
...
- Reserved words in {{Lang}} that member names may collide with — and the
  escape convention.
...
the idiomatic {{Lang}} shape — keyword arguments, a value class, a hash/map,
a builder?
...
What does "implements IBucket" look like in {{Lang}}, and how does the
...
how do they read in idiomatic {{Lang}}?
